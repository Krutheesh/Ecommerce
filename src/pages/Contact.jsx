...
function Contact() {
  return (
    <div>
      <h2 className="pt-[5rem] pb-[1rem] text-center text-[1.5rem] text-gray-600">
        Contact us
      </h2>
      <iframe
      className="w-full h-[50vh] py-3 md:py-0 "
      ...
      ></iframe>
      <div className="">
        <form action="https://formspree.io/f/meqbqwqb" method="post" className="space-y-5 md:w-[25rem] w-[80%] m-auto  mt-[4rem] ">
